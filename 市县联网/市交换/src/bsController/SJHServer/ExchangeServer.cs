...
namespace ZIT.SJHServer.bsController.SJHServer
{
    class ExchangeServer
    {
        ...
        /// 在线的客户端
        /// </summary>
        public IList<ExchangeServerClient> OnlineClents;
        ...
        public ExchangeServer()
        {
            ...
            OnlineClents = new List<ExchangeServerClient>();
        }
        ...
        public void Start()
        {
            ...
            server = ScsServerFactory.CreateServer(new ScsTcpEndPoint(ExchangeServerPort));
        ...
        protected void Server_ClientDisconnected(object sender, ServerClientEventArgs e)
        {
            try
            {
                ...
                try
                {
                    foreach (ExchangeServerClient Client in OnlineClents)
                    {
