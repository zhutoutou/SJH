...
namespace ZIT.SJHServer.fnLocalDataAccess.Oracle
{
    internal class GetDataSql
    {
        ...
        {
            string strSql = "select * from Web_MedicalStatistics where isupdated=1 and ID is not null and rownum<" + rownum;
            return strSql;
        }
        ...
        /// <summary>
        /// 联网调度关联表数据
        ///  主键: RemoteLSH,  RemoteDWBH,  LocalLSH
        /// </summary>
        /// <returns></returns>
        public static string GetLWDDGLBStr()
        {
            string strSql = "select * from LWDDGLB where isupdated=1 and RemoteLSH is not null and RemoteDWBH is not null and LocalLSH is not null and rownum<" + rownum;
            return strSql;
        }

        /// <summary>
        /// 联网车辆同步对应表数据
        ///  主键: LocalLSH,  LocalCS,  LocalCLBH
        /// </summary>
        /// <returns></returns>
        public static string GetLWCLTBDYBStr()
        {
            string strSql = "select * from LWCLTBDYB where isupdated=1 and LocalLSH is not null and LocalCS is not null and LocalCLBH is not null and rownum<" + rownum;
            return strSql;
        }

        /// <summary>
        /// 联网病历同步对应表数据
        ///  主键: LocalLSH,  LocalRecordID
        /// </summary>
        /// <returns></returns>
        public static string GetLWBLTBDYBStr()
        {
            string strSql = "select * from LWBLTBDYB where isupdated=1 and LocalLSH is not null and LocalRecordID is not null and rownum<" + rownum;
            return strSql;
        }

        /// <summary>
        /// 联网病历关系同步对应表数据
        ///  主键:LocalLSH,LocalStatisticsID
        /// </summary>
        /// <returns></returns>
        public static string GetLWBLGXTBDYBStr()
        {
            string strSql = "select * from LWBLGXTBDYB where isupdated=1 and LocalLSH is not null and LocalStatisticsID is not null and rownum<" + rownum;
            return strSql;
        }
    }
}
