    ...
    public class GetData : IGetData
    {
        ...
        public List<VehicleData> GetVehicleData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetVehicleDataStr());
        ...
        public List<SysUserData> GetSysUserData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetSysUserDataStr());
                foreach (DataRow r in dt.Rows)
                {
                    try
                    {
        ...
        public List<PVRelation> GetPVRelationData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetPVRelationDataStr());
                foreach (DataRow r in dt.Rows)
                {
                    try
                    {
        ...
        public List<DealData> GetDealData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetDealDataStr());
                foreach (DataRow r in dt.Rows)
                {
                    try
                    {
        ...
        public List<DispatchVehicleData> GetDispatchVehicleData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetDispatchVehicleDataStr());
                foreach (DataRow r in dt.Rows)
                {
                    try
                    {
        ...
        public List<SuffererData> GetSuffererData()
        {
            ...
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetSuffererDataStr());
                foreach (DataRow r in dt.Rows)
                {
                    try
                    {
        ...
        public List<SuffererCaseHistoryData> GetSuffererCaseHistoryData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetSuffererCaseHistoryDataStr());
                foreach (DataRow r in dt.Rows)
                {
                    try
                    {
        ...
        public List<CallRcordData> GetCallRcordData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetCallRcordDataStr());
                foreach (DataRow r in dt.Rows)
                {
                    try
                    {
        ...
        public List<UnitInfoData> GetUnitInfoData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetUnitInfoDataStr());
                foreach (DataRow r in dt.Rows)
                {
                    try
                    {
        ...
        public List<LargeSlipData> GetLargeSlipData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetLargeSlipDataStr());
                foreach (DataRow r in dt.Rows)
                {
        ...
        public List<DispatchStationInfoData> GetDispatchStationInfoData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetDispatchStationInfoDataStr());
                foreach (DataRow r in dt.Rows)
                {
                    try
                    {
        ...
        public List<Web_MedicalProject> GetWeb_MedicalProjectData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetWeb_MedicalProjectStr());
                foreach (DataRow r in dt.Rows)
                {
        ...
        public  List<Web_MedicalProjectValue> GetWeb_MedicalProjectValueData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetWeb_MedicalProjectValueStr());
                foreach (DataRow r in dt.Rows)
                {
        ...
        public List<Web_MedicalRecords> GetWeb_MedicalRecordsData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetWeb_MedicalRecordsStr());
                foreach (DataRow r in dt.Rows)
                {
                    ...
                    //20160105 修改人:朱星汉 修改内容:县若SWDD_TJ为空时,则赋SWDD的值
                    if (r["SWDD_TJ"].ToString() == "")
                    {
                        item.SWDD_TJ = r["SWDD"].ToString();
                    }
                    else 
                    {
        ...
        public List<Web_MedicalStatistics> GetWeb_MedicalStatisticsData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetWeb_MedicalStatisticsStr());
                foreach (DataRow r in dt.Rows)
                {
        ...
        public List<BLJCXXB> GetBLJCXXBData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetBLJCXXBStr());
                foreach (DataRow r in dt.Rows)
                {
        ...
        public List<HJQYB> GetHJQYBData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetHJQYBStr());
                foreach (DataRow r in dt.Rows)
                {
        ...
        public List<LDLXB> GetLDLXBData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetLDLXBStr());
                foreach (DataRow r in dt.Rows)
                {
        ...
        public List<ZBYXXB> GetZBYXXBData()
        {
            ...
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetZBYXXBStr());
                foreach (DataRow r in dt.Rows)
                {
        ...
        public List<ZZB> GetZZBData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetZZBStr());
                foreach (DataRow r in dt.Rows)
                {
                    ZZB item = new ZZB();
                    item.CommandID = "ZZB";
        ...
        public List<LWBLGXTBDELB> GetLWBLGXTBDELBData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetLWBLGXTBDELBStr());
                foreach (DataRow r in dt.Rows)
                {
        ...
        //20150105修改人:朱星汉 修改内容:添加病历记录删除表的上传
        /// <summary>
        /// 病历关系记录删除表数据
        /// </summary>
        /// <returns></returns>
        public List<LWBLTBDELB> GetLWBLTBDELBData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetLWBLTBDELBStr());
                foreach (DataRow r in dt.Rows)
                {
        ...
        public List<DXSGB> GetDXSGBData()
        {
            try
            {
                ...
                DataTable dt = OraclHelp.GetRecord(GetDataSql.GetDXSGBStr());
                foreach (DataRow r in dt.Rows)
                {
